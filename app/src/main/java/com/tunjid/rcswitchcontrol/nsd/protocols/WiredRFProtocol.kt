...
class WiredRFProtocol internal constructor(driver: UsbSerialDriver, printWriter: PrintWriter) : CommsProtocol(printWriter) {
    ...
    private fun onSerialRead(rawData: ByteArray) = Payload(this@WiredRFProtocol.javaClass.name).let {
        it.addCommand(RESET)
