...
import static com.tunjid.rcswitchcontrol.services.ClientBleService.DATA_TRANSCEIVER_SERVICE;
    ...
    public BleScanViewModel(@NonNull Application application) {
        ...
        if (bluetoothManager != null) scanner = BLEScanner.getBuilder(bluetoothManager.getAdapter())
                .addFilter(ScanFilterCompat.getBuilder()
                        .setServiceUuid(new ParcelUuid(UUID.fromString(DATA_TRANSCEIVER_SERVICE)))
                        .build())
